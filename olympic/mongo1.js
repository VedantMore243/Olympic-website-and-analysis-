...
const url = 'mongodb://localhost:27017/Olympic';
...
// ✅ Add this line to serve static CSS and assets correctly
app.use('/Asset/Assets', express.static(__dirname + '/Asset/Assets'));
...
app.post('/signup.html', function (req, res) {
    ...
    var mailoptions = {
        from: 'vrushalijatak@kccemsr.edu.in',
        to: req.body.email,
...
`
    ...
    const transporter = nodemailer.createTransport({
      ...
      auth: {
          user: 'vrushalijatak@kccemsr.edu.in',
          pass: 'Kccemsr@123'
      }
    });
